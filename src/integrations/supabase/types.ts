  ...
  public: {
    Tables: {
      ai_alert_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_alert_notifications_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
      ...
      client_wallet_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_wallet_transactions_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
            referencedRelation: "reports"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_wallet_transactions_wallet_id_fkey"
            columns: ["wallet_id"]
            isOneToOne: false
            referencedRelation: "client_wallet"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      project_weekly_progress: {
        Row: {
          actual_period: number | null
          actual_presence: number | null
          created_at: string | null
          created_by: string | null
          date: string
          id: string
          planned_period: number | null
          planned_presence: number | null
          project_id: string
          updated_at: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_weekly_progress_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_weekly_progress_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      reports: {
        Row: {
          ...
          amt_deviation_hours: string | null
          ...
          climatic_deviation_hours: string | null
          ...
          operational_deviation_hours: string | null
      ...
      service_report_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_report_templates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_client_report_ids: { Args: { _user_id: string }; Returns: string[] }
      get_company_contact_id: { Args: { _user_id: string }; Returns: string }
      get_company_contact_project_ids: {
        Args: { _user_id: string }
        Returns: string[]
      }
      get_company_contact_report_ids: {
        Args: { _user_id: string }
        Returns: string[]
      }
      ...
      get_contact_report_ids: { Args: { _user_id: string }; Returns: string[] }
      ...
      get_next_rdo_number: { Args: { p_project_id: string }; Returns: number }
      get_or_create_wallet: { Args: { _client_id: string }; Returns: string }
    ...
    Enums: {
      ...
      redemption_status: "pending" | "approved" | "delivered" | "cancelled"
      report_status: "draft" | "completed" | "sent" | "signed" | "finalized"
      reward_category: "physical" | "voucher" | "service_discount" | "donation"
