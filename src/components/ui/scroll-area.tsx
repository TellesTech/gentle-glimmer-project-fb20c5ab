...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    forceMount
    className={cn(
      "flex touch-none select-none transition-colors bg-muted/40 rounded-full",
  ...
  >
    <ScrollAreaPrimitive.ScrollAreaThumb 
      className={cn(
        "relative flex-1 rounded-full bg-muted-foreground/50 hover:bg-muted-foreground/70 transition-colors",
